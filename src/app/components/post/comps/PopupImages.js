...
import {PostStatLine} from "src/app/components/post/comps/PostStatLine";
...
const connector = connect((state) => {
  return {
    open: state.post.popupImages.open,
    postId: state.post.popupImages.postId,
    item: state.post.popupImages.item,
    sharedObj: state.post.popupImages.sharedObj,
    imageURLs: state.post.popupImages.imageURLs,
    headerContent: state.post.popupImages.headerContent,
    currentIndex: state.post.popupImages.currentIndex,
    type: state.post.popupImages.type,
    xStats: state.post.popupImages.xStats,
    hidePostStatLine: state.post.popupImages.hidePostStatLine,
    onClose: state.post.popupImages.onClose,
  };
});

export const PopupImages = connector(_PopupImages);

function _PopupImages({
  open,
  onClose,
  item = null,
  postId = null,
          ...
          return (
            <div>
              ...
              >
                ...
                {!hidePostStatLine && item && type === "post" && (
                  <PostStatLine
